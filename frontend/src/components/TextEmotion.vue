...
<template>
    ...
    <form class="d-flex" role="search" @submit.prevent="submitFunc">
      <keep-alive>
        <input
          ...
          id="search"
          type="search"
          placeholder="Search for your interested topics"
          aria-label="Search"
          v-model="text"
        />
      </keep-alive>
      <button class="btn btn-outline-success" type="submit" @click="Assign()">
        Search
      </button>
      <button
  ...
  <div style="display: flex">
    ...
    <div v-if="text === ''" style="position: fixed; right: 20px; left: 950px">
      <Barchart />
    </div>
  </div>
